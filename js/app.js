    ...
    (() => {
                ...
                filterButtons.forEach((button => {
                    button.addEventListener("click", (() => {
                        ...
                        productSlider.querySelectorAll(".product__slide").forEach((slide => {
                            if ("all" === category || slide.getAttribute("data-filter") === category) slide.style.display = "block"; else {
        ...
        productsBtn.forEach((el => {
            ...
            el.addEventListener("click", (e => {
                ...
                let title = parent.querySelector(".product__body-title").textContent;
        ...
        productsBtn.forEach((function(item) {
